...
class Thread3 implements Runnable{
    public void run(){
        int count = 0;
        while(count < 100000){
            System.out.println("I am thread 1 of runnable interface.");
            count++;
        }
    }
}
...
class Thread4 implements Runnable{
    public void run(){
        int count = 0;
        while(count < 1000000){
            System.out.println("I am thread 2 of runnable interface.");
            count++;
        }
    }
}
public class CWH_Multithreading_RunnableInterface {
